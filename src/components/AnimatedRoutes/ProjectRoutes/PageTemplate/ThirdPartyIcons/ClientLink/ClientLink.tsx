...
export const ClientLink = ({ backgroundColor, clientUrl }: Props) => {
  const [iconIsHovered, setIconIsHovered] = useState(false);

  return (
    <a href={clientUrl} target="_blank" rel="noreferrer nopener">
      <div
